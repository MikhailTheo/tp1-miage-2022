...
Théo Vigneron et Mikhail Kuchukidze
...
Le code de metier se trouve dans le fichier :
...
(au preàlable avoir initialisé la classe TodoListController ainsi qu'un TodoItem)
String résultatAttendu = "Late contentdemonstring";  
String resultatObtenu = TodoListController.finalContent(TodoItem)  
...
Nous devrons ecrire des Tests d'intégration

*Que teste-on dans ce cas ?*

Il faut tester l'ensemble des modules et la compatibilité entre eux
